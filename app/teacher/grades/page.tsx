...
export default async function TeacherGradesPage() {
  ...
  return (
    <div className="space-y-4 text-white">
      <h1 className="text-3xl font-semibold">Оценки (версия для преподавателя)</h1>
      <p className="text-slate-300">
        Здесь можно будет работать с оценками студентов и курсами. Пока оставил заглушку, чтобы страница была доступна только преподавателям.
      </p>
    </div>
  );
}
